...
if( count($response) ){
?>
	<form id="impact_band" name="impactband" method="post" action="" class="impact-form form-inline">
		Vous devez au préalable définir un nouveau rangement pour les albums suivant :
		<br />
		<?php
			$i = 0;
			$currentSaga = null;
