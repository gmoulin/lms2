...
if( count($response) ){
?>
	<form id="impact_artist" name="impactartist" method="post" action="" class="impact-form form-inline">
		Vous devez au préalable définir un nouveau rangement pour les films suivant :
		<br />
		<?php
			$i = 0;
			$currentSaga = null;
